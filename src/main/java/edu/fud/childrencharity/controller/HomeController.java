package edu.fud.childrencharity.controller;

//import edu.fud.childrencharity.repository.TestRespository;
import edu.fud.childrencharity.repository.UserRespository;
...
public class HomeController {
    ...
    //@Autowired
    //private TestRespository1 test1;
    ...
    public String Home(Model model) {
        //model.addAttribute("test", test1.findAll());
        //model.addAttribute("test", test1.findAll());
        //model.addAttribute("test", test2.findAll());
        return "index";
    }
